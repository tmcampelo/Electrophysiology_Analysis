...
# %% Extract DOWN state from UP state whisker-evoked PSP
...
del Vm_cutoff, data, dataDown, sweepNumber, histogram, bins, ID_hist_max, abf, Vm_distribution, a, b, c
...
del a0, b0, bap, c0, fit, fres, i, ind_end, ind_start, p1, p2, p3, pcov, popt, residuals, seal_vm, seal_ts, cleanedFits, PSPdown, Vm_ts

# TimePlots of RM and Chi of the fitting
plt.figure (5)
plt.ylabel("RIM")
plt.xlabel("Sweeps")
